        ...
        mutantResults.forEach(function (result) {
            ...
            switch (result.status) {
                case report_1.MutantStatus.Killed:
                    _this.log.debug(chalk.bold.green('Mutant killed!'));
                    _this.logMutantResult(result, logDebugFn);
                    break;
                case report_1.MutantStatus.TimedOut:
                    _this.log.debug(chalk.bold.yellow('Mutant timed out!'));
                    _this.logMutantResult(result, logDebugFn);
                    break;
                case report_1.MutantStatus.RuntimeError:
                    _this.log.debug(chalk.bold.yellow('Mutant caused a runtime error!'));
                    _this.logMutantResult(result, logDebugFn);
                    break;
                case report_1.MutantStatus.TranspileError:
                    _this.log.debug(chalk.bold.yellow('Mutant caused a transpile error!'));
                    _this.logMutantResult(result, logDebugFn);
                    break;
