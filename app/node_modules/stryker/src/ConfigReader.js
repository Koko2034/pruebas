...
var ConfigReader = /** @class */ (function () {
    ...
    ConfigReader.prototype.validate = function (options) {
        if (VALID_COVERAGE_ANALYSIS_VALUES.indexOf(options.coverageAnalysis) < 0) {
            this.log.fatal("Value \"" + options.coverageAnalysis + "\" is invalid for `coverageAnalysis`. Expected one of the folowing: " + VALID_COVERAGE_ANALYSIS_VALUES.map(function (v) { return "\"" + v + "\""; }).join(', '));
            process.exit(1);
        }
