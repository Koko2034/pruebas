...
var Stryker = /** @class */ (function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        initialTestRunProcess = this.createInitialTestRunner(inputFiles);
    ...
    Stryker.prototype.mutate = function (inputFiles, initialTestRunResult) {
        ...
        var mutantRunResultMatcher = new MutantTestMatcher_1.default(mutants, inputFiles, initialTestRunResult.runResult, initialTestRunResult.statementMaps, this.config, this.reporter);
    ...
    Stryker.prototype.createInitialTestRunner = function (inputFiles) {
